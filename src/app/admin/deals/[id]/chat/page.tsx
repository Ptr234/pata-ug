...
export default function AdminDealChatPage() {
              ...
              {dealStatus === "negotiating" && (
                <button
                  ...
                  onClick={() => {
                    ...
                    handleSend("Great news — the tenant has agreed to the terms. We've sent you the commission payment link (5%). Once both payments are confirmed, we'll connect you both.", "landlord");
                  }}
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    handleSend(
                      ...
                      `💰 Agreed Rent: ${info.rent}/month\n` +
                      `💳 Deposit has been transferred to your account (minus 5% commission).\n\n` +
